...
- Multiple triggers use their own qualities sequentially. Skip, reduced motion, hidden and cancel use the same true final state; non-triggering rewards, type-2 refunds and extras keep ordinary quantities without exclamations.
- Reuse the existing buff-quality palette. Keep 1300ms timing, icon colors, audio, actual amounts and resource operations unchanged. Fit narrow columns without clipping or moving the footer.
- No generated assets, configuration or player-data changes, or screenshot acceptance.
